...
{        
    ...
    const uint32_t StartableProcessesAmount = 2;
    ...
    {    
        ...
        case STL::PROM::INIT:
        {
            ...
            for (uint32_t i = 0; i < StartableProcessesAmount; i++)
            {
                ...
                StartableProcesses[i].Button = STL::Button(STL::ARGB(200), StartableProcesses[i].Name, TopLeft, BottomRight);
            }
